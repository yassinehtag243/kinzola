...
export default function MessageNotificationBanner() {
  ...
  const handleReply = useCallback(() => {
    ...
    const convId = activeNotification.conversationId;
    const senderName = activeNotification.senderName;
    // Set states first (batched by React)
    setTab('messages');
    openChat(convId);
    ...
    // Delay dismiss slightly so states propagate before banner unmounts
    setTimeout(() => handleDismiss(0), 100);
      ...
      {activeNotification && (
        ...
        >
          ...
          >
            ...
            {/* Action buttons — stopPropagation on pointerDown to prevent parent drag interference */}
            <div
